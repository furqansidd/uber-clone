...
const CaptainForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${backendUrl}/auth/captain/forgot-password`, { email });
    ...
    <div className="bg-white text-[#1a1c1c] min-h-screen flex flex-col justify-between">
      ...
      <main className="flex-grow flex flex-col px-4 pt-32 pb-8 max-w-md mx-auto w-full">
        ...
        <section className="mb-8 text-left">
          <h2 className="text-[26px] font-bold text-black mb-1">Forgot Password</h2>
          <p className="text-sm text-[#5d5f5f]">Enter your registered email address and we'll send you a password reset link.</p>
        </section>
